...
using ICartService = BlazorEcommerce.Server.CartService.ICartService;
...
public class CartController : ControllerBase
{
    ...
    [HttpPost("products")]
    public async Task<ActionResult<ServiceResponse<List<CartProductResponseDTO>>>> GetProducts(List<CartItem> cartItems)
    {
